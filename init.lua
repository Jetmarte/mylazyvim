...
vim.cmd("highlight LineNr guifg=#14a8e3") -- Color para el modo Normal
vim.api.nvim_create_autocmd("ModeChanged", {
  ...
  callback = function()
    ...
    elseif mode == "i" then
      ...
      vim.cmd("highlight LineNr guifg=#87de99") -- Color para el modo Normal
    elseif mode == "v" or mode == "V" or mode == "" then
      -- vim.cmd("hi Normal guibg=#2e1509") -- Fondo para modo Visual
      vim.cmd("highlight LineNr guifg=#db4f4f") -- Color para el modo Normal
    end
  end,
})
